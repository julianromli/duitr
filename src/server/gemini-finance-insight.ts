...
// Main server handler
// =================================================================
export async function handleGeminiFinanceInsightRequest(req: Request): Promise<Response> {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Gagal mendapatkan insight dari AI';
    return new Response(JSON.stringify({
      error: message,
    }), {
      status: 500,
